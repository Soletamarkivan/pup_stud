...
$sql = "SELECT trip_ticket_date, vehicle_type, plate_num, gas_tank, purchased_gas, total, start_odometer, end_odometer, KM_used, RFID_Easy, RFID_Auto, oil_used FROM trip_ticket";
...
<html lang="en">
    <head>
        ...
        <title>Latest Trip Ticket</title>
    </head>
            ...
            <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
                <div class="container-fluid d-flex flex-column p-0">
                    ...
                    <ul class="navbar-nav text-light" id="accordionSidebar">
                        ...
                        <li class="nav-item">
                            <a class="nav-link collapsed active" href="#" data-bs-toggle="collapse" data-bs-target="#collapseMaintenance" aria-expanded="false" aria-controls="collapseMaintenance"><i class="fas fa-tools"></i><span>MAINTENANCE</span></a>
                                ...
                                <li class="nav-item dropdown no-arrow">
                                    <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small">Mechanic</span><img class="border rounded-circle img-profile" src="assets/img/avatars/example.jpg"></a>
                                        <div class="dropdown-menu shadow dropdown-menu-end animated--grow-in">
                                            <a class="dropdown-item" href="/Gearchanix/GEARCHANIX-main/gearchanix/public/pages/supervisor/profile-supervisor.html"><i class="fas fa-user fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Profile</a>
                    ...
                    <div class="scrollable-container">
                        <div class="container-fluid">
                            <div class="d-sm-flex justify-content-between align-items-center mb-4">
                                <h3 class="text-dark mb-0">Latest Trip Ticket List</h3>
                            </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="exportForm" action="export_triptix.php" method="GET">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <input type="checkbox" id="date" name="columns[]" value="date">
                                                                <label for="date">Date</label><br>
                                                                <input type="checkbox" id="vehicle_type" name="columns[]" value="vehicle_type">
                                                                <label for="vehicle_type">Vehicle Type</label><br>
                                                                <input type="checkbox" id="plate_number" name="columns[]" value="plate_number">
                                                                ...
                                                                <input type="checkbox" id="total_gas" name="columns[]" value="total_gas">
                                                                <label for="total_gas">Total Gas</label><br>
                                                            </div>
                                                            <div class="col-md-6">
                            ...
                            <!--Latest Trip Ticket List Table-->
                            <div class="card shadow" style="margin-top: 30px">
                                <div class="card-header py-3">
                                    <p class="text-primary m-0 fw-bold">Latest Trip Ticket List Info</p>
                                </div>
                                <div class="card-body">
                                <div class="row">
