...
if (isset($data->trip_ticketID)) {
    ...
    $query = "DELETE FROM history_triptix WHERE trip_ticketID = ?";
...
$sql = "SELECT trip_ticketID, trip_ticket_date, vehicle_type, plate_num, gas_tank, purchased_gas, total, start_odometer, end_odometer, KM_used, RFID_Easy, RFID_Auto, oil_used FROM history_triptix";
