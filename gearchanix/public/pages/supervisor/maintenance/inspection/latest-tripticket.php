                        ...
                        <li class="nav-item">
                            ...
                            <div id="collapseRoles" class="collapse" aria-labelledby="headingRoles" data-bs-parent="#accordionSidebar">
                                <div class="bg-white py-2 collapse-inner rounded">
                                    <a class="collapse-item active" href="/Gearchanix/GEARCHANIX-MAIN/gearchanix/public/pages/supervisor/roles/admin-list.html"><i class="fas fa-user-circle"></i> ADMIN LIST</a>
                        ...
                        <li class="nav-item">
                            ...
                            <div id="collapseVehicles" class="collapse" aria-labelledby="headingVehicles" data-bs-parent="#accordionSidebar">
                                <div class="bg-white py-2 collapse-inner rounded">
                                    ...
                                    <a class="collapse-item" href="/Gearchanix/GEARCHANIX-main/gearchanix/public/pages/supervisor/vehicles/vehicle-history.html"><i class="fas fa-history"></i> VEHICLE HISTORY</a>
                                </div>
                            </div>
                        </li>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="exportForm" action="export_latest_triptix.php" method="GET">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="checkbox" id="plate_number" name="columns[]" value="plate_num">
