$(document).ready(function() {
    ...
    function fetchTripTickets() {
        $.ajax({
            url: '/Gearchanix/GEARCHANIX-main/gearchanix/public/pages/mechanic/maintenance/inspection/fetch_trip_tickets.php', // Ensure this URL points to your PHP file
            method: 'GET',
    ...
    $('#saveChanges').click(function() {
        ...
        $.ajax({
            url: '/Gearchanix/GEARCHANIX-main/gearchanix/public/pages/mechanic/maintenance/inspection/update_pdi_form.php', // PHP file to update the record
            type: 'POST',
            data: {
                pdi_ID: pdi_ID,
                driver: driver,
    ...
    window.editPdiForm = function(pdi_ID) {
        $.ajax({
            url: '/Gearchanix/GEARCHANIX-main/gearchanix/public/pages/mechanic/maintenance/inspection/get_pdi_form.php', // PHP file to fetch the record
            type: 'GET',
            data: { pdi_ID: pdi_ID },
            success: function(response) {
    ...
    window.openChecklist = function(pdiId) {
        ...
        $.ajax({
            url: '/Gearchanix/GEARCHANIX-main/gearchanix/public/pages/mechanic/maintenance/inspection/get_checklist_data.php', // PHP script to fetch current checklist data
            type: 'GET',
            data: { pdi_id: pdiId },
            dataType: 'json',
            success: function(data) {
    ...
    $('#saveChecklist').click(function() {
        ...
        $.ajax({
            url: '/Gearchanix/GEARCHANIX-main/gearchanix/public/pages/mechanic/maintenance/inspection/update_checklist.php', // Your PHP script to update the checklist
            type: 'POST',
            data: checklistData,
