...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 30, 2024 at 05:09 PM
...
CREATE TABLE `maintenance_request` (
  ...
  `vehicle_type` enum('Bus','Motor','Car','Mini Bus','Van') NOT NULL,
  `plate_num` varchar(10) NOT NULL,
...
INSERT INTO `maintenance_request` (`queue_num`, `reminder_ID`, `vehicle_name`, `vehicle_type`, `plate_num`, `driver`, `service_task`, `start_date`, `target_date`, `parts`, `receiver`, `date`, `noted_by`, `approval_chief`, `approval_office`) VALUES
(9, 67, 'Honda Civic', 'Bus', 'XYZ123', NULL, 'Preventive Maintenance', NULL, '2024-11-01', '', NULL, NULL, NULL, 'Approved', 'Pending'),
(10, 70, 'Kawasaki wikiwik', 'Car', 'HaC10a', NULL, 'Semi-Synthetic Oil Change', NULL, '2024-11-01', 'Air FIlter', NULL, NULL, NULL, 'Approved', 'Pending'),
(11, 76, 'Honda Civic', 'Bus', 'XYZ123', NULL, 'Fully Synthetic Oil Change', NULL, '2024-10-31', 'Battery,Lights', NULL, NULL, NULL, 'Approved', 'Approved');
...
INSERT INTO `password_resets` (`id`, `user_email`, `token`, `created_at`) VALUES
(13, 'darryljhan76@gmail.com', '775bfac8096467d9e71d2706e1ed2db787685d5bb2f1a10984a58358f979e4a880156838f86ddbce059e95c4504561508ad7', '2024-10-30 14:56:48');
...
(75, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 113, 'HAL123', 'pending');
...
INSERT INTO `pms` (`pms_ID`, `vehicle_ID`, `vehicle_model`, `plate_num`, `queue_num`, `acquisition_date`, `target_date`, `workorder_ID`, `parts`, `service_task`) VALUES
(1, 55, '2022', 'XYZ123', 11, '2024-10-30', '2024-10-31', 1, 'Battery,Lights', 'Fully Synthetic Oil Change');
...
INSERT INTO `service_reminder` (`reminder_ID`, `task_ID`, `vehicle_type`, `plate_num`, `service_task`, `status`, `next_due`, `Meter_until_due`, `est_days`, `pms_date`, `latest_odometer`, `parts`, `target_date`) VALUES
(67, 7, 'Bus', 'XYZ123', 'Preventive Maintenance', 'Overdue', 7500, -1500, NULL, NULL, 9000, '', '2024-11-01'),
(68, 9, 'Bus', 'XYZ123', 'nnn', 'Overdue', 7500, -1500, NULL, NULL, 9000, '', '2024-10-31'),
(69, 3, 'Bus', 'XYZ123', 'Semi-Synthetic Oil Change', 'Overdue', 7500, -1500, NULL, NULL, 9000, 'Battery, Lights', NULL),
(70, 3, 'Car', 'HaC10a', 'Semi-Synthetic Oil Change', 'Due Soon', 7500, -500, -1, '2024-10-27', 8000, 'Air FIlter', '2024-11-01'),
(71, 7, 'Car', 'HaC10a', 'Preventive Maintenance', 'Due Soon', 7500, -500, -1, '2024-10-30', 8000, 'Air FIlter', NULL),
(72, 9, 'Car', 'HaC10a', 'nnn', 'Due Soon', 7500, -500, -1, '2024-11-03', 8000, 'Air FIlter', NULL),
(73, 7, 'Motor', 'HAL123', 'Preventive Maintenance', 'Due Soon', 5000, -325, -1, '2024-10-27', 5325, 'Engine2', NULL),
(74, 9, 'Motor', 'HAL123', 'nnn', 'Due Soon', 5000, -325, -1, '2024-10-31', 5325, 'Engine2', '2024-10-31'),
(75, 6, 'Car', 'HaC10a', 'Fully Synthetic Oil Change', 'Due Soon', 10000, 2000, 2, '2024-10-30', 8000, 'Air FIlter', NULL),
(76, 6, 'Bus', 'XYZ123', 'Fully Synthetic Oil Change', 'Due Soon', 10000, 1000, NULL, NULL, 9000, 'Battery, Lights', '2024-10-31');
...
(99, '2024-10-31', NULL, NULL, NULL, 2000, 9000, 7000, NULL, NULL, NULL, 'Bus', 'XYZ123', 54),
(100, '2024-11-01', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Bus', 'XYZ123', 55),
(104, '2024-11-01', NULL, NULL, NULL, 3000, 3500, 500, NULL, NULL, NULL, 'Car', 'HaC10a', 59),
(105, '2024-11-01', NULL, NULL, NULL, 3500, 8000, 4500, NULL, NULL, NULL, 'Car', 'HaC10a', 60),
...
('Car', 'HaC10a', 56, 5000, 8000, NULL, 750, 0),
('Motor', 'HAL123', 57, 2325, 5325, NULL, 625, 0),
('Bus', 'XYZ123', 55, 9000, 9000, NULL, NULL, 0);
...
CREATE TABLE `work_order` (
  ...
  `replaced_parts` varchar(100) DEFAULT NULL,
...
INSERT INTO `work_order` (`workorder_ID`, `assigned_to`, `replaced_parts`, `activity`, `remarks`) VALUES
...
--
ALTER TABLE `maintenance_request`
  MODIFY `queue_num` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `pdi_form`
  MODIFY `pdi_ID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;

--
-- AUTO_INCREMENT for table `pms`
--
ALTER TABLE `pms`
  MODIFY `pms_ID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `service_reminder`
  MODIFY `reminder_ID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
...
--
ALTER TABLE `work_order`
  MODIFY `workorder_ID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `maintenance_request`
  ADD CONSTRAINT `maintenance_request_ibfk_1` FOREIGN KEY (`reminder_ID`) REFERENCES `service_reminder` (`reminder_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
